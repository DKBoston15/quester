      ...
      <Dialog as="div" className="relative z-10" onClose={setOpen}>
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform rounded-lg sm:h-80 h-80 bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                  ...
                  <div className="px-2 py-5 sm:p-6 w-full h-full">
                    ...
                    <form className="mt-5 sm:flex sm:items-center w-full flex-col flex">
                      <div className="w-full">
                        <label htmlFor="paradigmName" className="sr-only">
                          Paradigm
                        </label>
                        <input
                          name="paradigmName"
