...
import useGetQuestionsByIdQuery from 'hooks/questions/useQuestionsById';
import CreateQuestionModal from '../CreateModals/CreateQuestionModal';
...
export default function QuestionTable({
  ...
  const {
    ...
    isLoading,
    isError
  } = useGetQuestionsByIdQuery({ projectItemId });
        ...
        <div className="sm:flex sm:items-center">
          <div className="sm:flex-auto">
            ...
            <p className="mt-2 text-sm text-gray-700">
              ...
              understandings about the section of observations in research.
            </p>
          </div>
                        ...
                        {questions.map((question: any) => (
                          ...
                          >
                            ...
                            <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                              <a
                                href={`/app/projects/${projectItemId}/questions/${question.id}`}
