...
export default function LabTable({ projectItemId, setSelectedLab }: any) {
  const [open, setOpen] = useState(false);
  const {
    data: labs,
    isLoading,
    isError
  } = useGetLabsByIdQuery({ projectItemId });
        ...
        <div className="sm:flex sm:items-center">
          <div className="sm:flex-auto">
            ...
            <p className="mt-2 text-sm text-gray-700">
              ...
              the manner in which inquiry drives professionalism.
            </p>
          </div>
                        ...
                        {labs.map((lab: any) => (
                          ...
                          >
                            ...
                            <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                              <a
                                href={`/app/projects/${projectItemId}/labs/${lab.id}`}
