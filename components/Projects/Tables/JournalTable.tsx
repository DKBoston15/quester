...
export default function JournalTable({
  ...
  const {
    ...
    isLoading,
    isError
  } = useGetJournalsByIdQuery({ projectItemId });
      ...
      <div className="px-4 pt-4 sm:px-6 lg:px-8">
        <div className="sm:flex sm:items-center">
          <div className="sm:flex-auto">
            <h1 className="text-xl font-semibold text-gray-900">Journals</h1>
            <p className="mt-2 text-sm text-gray-700">NEED A DESCRIPTION</p>
          </div>
                      ...
                      <>
                        {journals.map((journal: any) => (
                          ...
                          >
                            ...
                            <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                              {journal.impact_score}
                            </td>
                            <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                              <a
                                href={`/app/projects/${projectItemId}/journals/${journal.id}`}
