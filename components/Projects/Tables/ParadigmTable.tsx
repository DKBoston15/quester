...
import useGetParadigmsByIdQuery from 'hooks/paradigms/useParadigmsById';
import CreateParadigmModal from '../CreateModals/CreateParadigmModal';
...
export default function ParadigmTable({
  ...
  const {
    ...
    isLoading,
    isError
  } = useGetParadigmsByIdQuery({ projectItemId });
      ...
      <div className="px-4 pt-4 sm:px-6 lg:px-8">
        <div className="sm:flex sm:items-center">
          <div className="sm:flex-auto">
            <h1 className="text-xl font-semibold text-gray-900">Paradigms</h1>
                        ...
                        {paradigms.map((paradigm: any) => (
                          ...
                          >
                            ...
                            <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                              <a
                                href={`/app/projects/${projectItemId}/paradigms/${paradigm.id}`}
