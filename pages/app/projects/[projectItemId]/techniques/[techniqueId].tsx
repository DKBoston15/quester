...
import TechniqueContentCard from '@/components/Projects/ContentCards/TechniqueContentCard';
...
export default function Technique() {
  ...
  const { projectItemId, techniqueId } = router.query;
  const [openDeleteModal, setOpenDeleteModal] = useState(false);
  const {
    data: pulledTechnique,
    isLoading,
    isError
  } = useGetTechniqueByIdQuery({ id: techniqueId });
