...
import QuestionContentCard from '@/components/Projects/ContentCards/QuestionContentCard';

export default function Question() {
  const router = useRouter();
  const { projectItemId, questionId } = router.query;
  const [openDeleteModal, setOpenDeleteModal] = useState(false);
  const {
    data: pulledQuestion,
    isLoading,
    isError
  } = useGetQuestionByIdQuery({ id: questionId });
